...
void CanDriver::CanSendMotorSpeed(float _set_ch2_speed, float _set_ch3_speed)
{
    ...
    tx_frame.data.u8[3] = (int32_t)(_set_ch2_speed * 1000.0f) >> 24;
    tx_frame.data.u8[4] = (int32_t)(_set_ch3_speed * 1000.0f) & 0xff;
    tx_frame.data.u8[5] = (int32_t)(_set_ch3_speed * 1000.0f) >> 8;
    tx_frame.data.u8[6] = (int32_t)(_set_ch3_speed * 1000.0f) >> 16;
    tx_frame.data.u8[7] = (int32_t)(_set_ch3_speed * 1000.0f) >> 24;
